...
os.makedirs("/home/ubuntu/ai_service/ai_service/app/outputs", exist_ok=True)
logging.basicConfig(
    level=logging.INFO,
    format="%(asctime)s - %(levelname)s - %(message)s",
    filename="/app/outputs/tts_server.log",
)
logger = logging.getLogger(__name__)


# --- Configuration ---
SERVER_HOST = "localhost"  # Allow connections from outside the container
SERVER_PORT = 8765  # Match the exposed port in Dockerfile 8765
...
async def main():
    ...
    try:
        ...
        global_coqui_engine = FishEngine(
            ...
            voices_path=None,
            reference_prompt_tokens="/home/ubuntu/ai_service/ref_kelly.npy",
            device="cuda",

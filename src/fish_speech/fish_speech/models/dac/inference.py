...
@click.option(
    "--input-path",
    "-i",
    default="/home/ubuntu/ai_service/WhatsApp Audio 2025-05-15 at 09.48.28.wav",
    type=click.Path(exists=True, path_type=Path),
)
@click.option(
    "--output-path", "-o", default="lebenan.wav", type=click.Path(path_type=Path)
)
@click.option("--config-name", default="modded_dac_vq")
@click.option(
    "--checkpoint-path",
    default="/home/ubuntu/ai_service/checkpoints/openaudio-s1-mini/codec.pth",
)
@click.option(
    "--device",
    "-d",

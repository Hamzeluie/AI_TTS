...
from models.fish_speech.utils.file import (
    AUDIO_EXTENSIONS,
    audio_to_bytes,
    list_files,
    read_ref_text,
)
from models.fish_speech.utils.schema import ServeReferenceAudio
...
class ReferenceLoader:
    ...
    def save_cache(self, path="ref_cache.pkl"):
        with open(path, "wb") as f:
            pickle.dump({"by_id": self.ref_by_id, "by_hash": self.ref_by_hash}, f)

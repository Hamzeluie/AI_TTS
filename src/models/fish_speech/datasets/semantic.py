...
from models.fish_speech.datasets.protos.text_data_pb2 import SampledData
from models.fish_speech.datasets.protos.text_data_stream import read_pb_stream
from models.fish_speech.text.clean import clean_text
from models.fish_speech.tokenizer import FishTokenizer
from models.fish_speech.utils import RankedLogger
from models.fish_speech.utils.braceexpand import braceexpand
...
if __name__ == "__main__":
    ...
    ds = AutoTextSemanticInstructionDataset(
        ["data/protos"],
        tokenizer=FishTokenizer("checkpoints//tokenizer.tiktoken"),
        use_speaker=False,

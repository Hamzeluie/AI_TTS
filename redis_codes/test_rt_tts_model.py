...
from real_time_tts_models import RedisQueueManager  # assuming your class is in a.py
...
async def client_task(client_id: int, sentences: List[str], redis_url: str, queue_name: str):
    ...
    for sentence in sentences:
        ...
        for i, word in enumerate(words):
            ...
            TextFeatures(sid=req_id, text=word, agent_name='call', priority='high' if i == 0 else 'low', created_at=time.time())
